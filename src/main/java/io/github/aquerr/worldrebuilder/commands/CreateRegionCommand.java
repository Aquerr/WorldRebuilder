...
public class CreateRegionCommand extends WRCommand
{
	...
	public CommandResult execute(final CommandSource source, final CommandContext args) throws CommandException
	{
		...
		final Region region = new Region(name, world.getUniqueId(), selectionPoints.getFirstPoint(), selectionPoints.getSecondPoint(), 10, true, true, new HashMap<>(), new ArrayList<>());
